...
public class CasaGUI extends JButton {
    ...
    public void desenhaPeca(String peca_nome){
        URL PEDRA_URL = CasaGUI.class.getResource("/resources/"+peca_nome.toLowerCase()+".png"); 
        Icon PEDRA_ICONE = new ImageIcon(PEDRA_URL);
        setIcon(PEDRA_ICONE);
    }
